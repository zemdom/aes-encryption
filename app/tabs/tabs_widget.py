...
class TabsWidget(QWidget):
    def __init__(self, height, width, input_queue, output_queue, gui_data, receiver_port, parent=None):
        super(QWidget, self).__init__(parent)
        self.send_tab = None
        self.receive_tab = None
        tabs = self.__create_tabs(height, width, input_queue, output_queue, gui_data, receiver_port)
    ...
    def __create_tabs(self, height, width, input_queue, output_queue, gui_data, receiver_port):
        tabs = QTabWidget()
        self.send_tab = SendTab(output_queue, gui_data)
